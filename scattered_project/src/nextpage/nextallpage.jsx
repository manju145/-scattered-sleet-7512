    ...
    return (
        <>
            ...
            <div className="Allfirsdiv">
                <h3 className="honename">Trending Ads</h3>
            ...
            <div className="Allsecsdiv">
                <h3 className="homesecpage">Mobile & Tablets</h3>
            ...
            <div className="threediv">
                <h3 className="homethrname">Home & Lifestyle</h3>
            ...
            <div className="fourdiv">
                <h3 className="homefourname">Electronics & Appliances</h3>
