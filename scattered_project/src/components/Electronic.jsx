        ...
        <>
            ...
            <div className="eletronicdiv">
                ...
                <div className="eletronicalldiv">
                     <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/air_conditions.png" alt="" />
                     <h3 className="eletronhthree">Air Conditioners </h3>
                     </div>
                     <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/Refrigerator.png" alt="" />
                     <h3 className="eletronhthree">Refrigerators</h3>
                     </div>
                     <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/Air_cooler.png" alt="" />
                     <h3 className="eletronhthree">Air Coolers</h3>
                     </div>
                     ...
                     <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/certified_landing_page/electronics/laptop.png" alt="" />
                     <h3 className="eletronhthree">Laptops</h3>
                     </div>
                     <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/Washing_machine.png" alt="" />
                     <h3 className="eletronhthree">Washing Machines</h3>
                     </div>
                     <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/inverter.png" alt="" />
                     <h3 className="eletronhthree">Inverters, UPS & Generators</h3>
                     </div>
                     <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/Desktop.png" alt="" />
                     <h3 className="eletronhthree">Desktop</h3>
                     </div>
                     <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/tv_s.png" alt="" />
                     <h3 className="eletronhthree">TVs</h3>
                     </div>
                     <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/videoGames.png" alt="" />
                     <h3 className="eletronhthree">Video Games</h3>
                     </div>
                     <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/Speaker.png" alt="" />
                     <h3 className="eletronhthree">Music Systems</h3>
                     </div>
                     <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/Camera.png" alt="" />
                     <h3 className="eletronhthree">Camera Digicams</h3>
                     </div>
                </div>
            </div>
