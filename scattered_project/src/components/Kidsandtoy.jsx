...
import '../App.css';
function KidsAndToys() {
    return (
        <>
            <div className="kidhead">
                <img src="https://teja8.kuikr.com/escrow/assets/image/category/ea-cat-dt-1280x250.jpg" alt="" />
            </div>

            <div className="eletronicdiv">
                <h1 className="eletronichone">Top Categories</h1>
                <div className="eletronicalldiv">
                    <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/Babies_Infants.png" alt="" />
                        <h3 className="eletronhthree">Prams,Walkers & Strollers</h3>
                    </div>
                    <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/Cradels_Cots.png" alt="" />
                        <h3 className="eletronhthree">Cradels & Cots</h3>
                    </div>
                    <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/chair.png" alt="" />
                        <h3 className="eletronhthree">Chairs</h3>
                    </div>
                    ...
                    <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/Baby_Feeding%20Items.png" alt="" />
                        <h3 className="eletronhthree">Baby feeding Items</h3>
                    </div>
                    <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/Games_Puzzle.png" alt="" />
                        <h3 className="eletronhthree">Games and Puzzel</h3>
                    </div>
                    <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/ToyVehicles.png" alt="" />
                        <h3 className="eletronhthree">Toy Vehicles</h3>
                    </div>
                    <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/kids.gif" alt="" />
                        <h3 className="eletronhthree">Educational Toys</h3>
                    </div>
                    <div className="eletronicimg"><img src="https://teja10.kuikr.com/escrow/assets/image/topCategories/kids_icon.jpg" alt="" />
                        <h3 className="eletronhthree">Kids Rhymes</h3>
                    </div>
                </div>
            </div>

            <div className="furthreediv">
                <h3 className="homfurname">Baby & Infant</h3>
                <div className="furnidimg">
                    <div className="imgehere">
                        <img src="https://teja8.kuikr.com/i4/20230118/Used-Baby-pram-working-fine-VB201705171774173-ak_LWBP1823305554-1674059458.webp" />
                        <h1 className="magr">Prams,Walkers & Strollers</h1>
                        <h1 className="price">₹11,000</h1>
                    </div>
                    <div className="imgehere">
                        <img src="https://teja8.kuikr.com/i5/20230108/BIG-Cot-bed-of--Mom---Me---Mahindra-Retail-brand--in-excellent-condition-with-5-inch-mattress--bedding--blanket-and-2-pillows-VB201705171774173-ak_LWBP1934927773-1673161178.webp" />
                        <h1 className="magr">Cradles and Cots</h1>
                        <h1 className="price">₹8,000</h1>
                    </div>
                    <div className="imgehere">
                        <img src="https://teja8.kuikr.com/i5/20221021/Chicco-baby-dining-chair-for-sale-bought-it-from-Ambience-mall-1-month-ago-VB201705171774173-ak_LWBP1638971917-1666333545.webp" />
                        <h1 className="magr">Chairs</h1>
                        <h1 className="price">₹17,009</h1>
                    </div>
                    <div className="imgehere">
                        <img src="https://teja8.kuikr.com/i5/20220731/Baby-Cot-with-Matress-and-Bumper-VB201705171774173-ak_WBP1381385491-1659288545.webp" />
                        <h1 className="magr">Bedding</h1>
                        <h1 className="price">₹15,00</h1>
                    </div>
                    <div className="imgehere">
                        <img src="https://teja8.kuikr.com/i5/20220902/Stokke-Baby-front-and-back-carrier-VB201705171774173-ak_LWBP654394507-1662120175.webp" />
                        <h1 className="magr">Baby Carriers</h1>
                        <h1 className="price">₹10,000</h1>
                    </div>

                    <div className="imgehere">
                        <img src="https://teja8.kuikr.com/i5/20220820/BOOSTER-SEAT-WITH-FEEDING-TRAY-FROM-MEE-MEE-VB201705171774173-ak_LWBP1222381000-1660981648.webp" />
                        <h1 className="magr">Baby Feeding Items</h1>
                        <h1 className="price">₹5,000</h1>
                    </div>
                    <div className="imgehere">
                        <img src="https://teja8.kuikr.com/i4/20220804/Carseat-for-toddlers-VB201705171774173-ak_LWBP399426783-1659585062.webp" />
                        <h1 className="magr">Baby Car Seats</h1>
                        <h1 className="price">₹4,999</h1>
                    </div>
                    <div className="imgehere">
                        <img src="https://teja8.kuikr.com/i4/20230119/Unused-breast-pump-for-Sale---Best-Brand-in-breast-pumps-VB201705171774173-ak_LWBP1631415306-1674144550.webp" />
                        <h1 className="magr">Breast Pump Sets</h1>
                        <h1 className="price">₹2,999</h1>
                    </div>
                    <div className="imgehere">
                        <img src="https://teja8.kuikr.com/i6/20220805/BABBY-BATH-TUB-VB201705171774173-ak_LWBP726493484-1659680107.webp" />
                        <h1 className="magr">Kids Bath Tubs</h1>
                        <h1 className="price">₹1,999</h1>
                    </div>
                    <div className="imgehere">
                        <img src="https://teja8.kuikr.com/i5/20221006/Mother-care-solid-wood-strong-and-steady-high-chair-VB201705171774173-ak_LWBP1413800431-1665025550.webp" />
                        <h1 className="magr">Baby High Chairs</h1>
